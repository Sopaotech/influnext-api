...
// Modelo de monetização: R$ 59,90/mês (Criador) e R$ 120,00/mês (Empresa)
// FREE  → plano sem assinatura ativa
// PRO   → Criador com assinatura ativa (R$ 59,90/mês) — legado, ainda em uso no DB
// MASTER → Empresa com assinatura ativa (R$ 120,00/mês) — legado, ainda em uso no DB
// ENTERPRISE → Contas especiais / parcerias estratégicas (créditos ilimitados)
