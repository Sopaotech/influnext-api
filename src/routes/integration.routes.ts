...
// Obter URLs de autorização (Instagram Creator API + TikTok)
router.get('/urls', authenticate, getAuthUrls);

// Alias direto para o modal de onboarding: GET /instagram/auth-url
router.get('/instagram/auth-url', authenticate, getAuthUrls);
