          ...
          {isIos ? (
            ...
            <>
              ...
              <button
                ...
                className="flex items-center gap-1.5 rounded-lg bg-gradient-to-r from-orange-600 to-orange-500 px-4 py-1.5 text-xs font-semibold text-white shadow-lg hover:from-orange-500 hover:to-amber-500 active:scale-[0.98] transition-all duration-200"
              >
