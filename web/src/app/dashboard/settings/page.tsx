                  ...
                  >
                      <div className="flex items-center gap-4">
                         <div className={`p-3 rounded-xl shadow-lg transition-all ${
                           connectedPlatforms.includes('INSTAGRAM') 
                             ? 'bg-gradient-to-tr from-yellow-600 via-pink-600 to-orange-600 text-white ring-2 ring-emerald-500 ring-offset-2 dark:ring-offset-[#0d0b1a] ring-offset-white' 
