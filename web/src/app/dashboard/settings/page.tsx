        ...
        <div className="space-y-1">
          <div className="flex items-center gap-3 mb-2">
             <div className="h-1.5 w-12 bg-orange-600 rounded-full" />
              <span className="text-[10px] font-black text-orange-500 uppercase tracking-[0.4em]">Studio Control Center</span>
          </div>
          <h1 className={`text-4xl md:text-7xl font-black tracking-tighter ${isDark ? 'text-white' : 'text-slate-900'}`}>
            Personalize seu <span className="text-orange-600 font-medium italic">Espaço</span>
          </h1>
        </div>
      </header>
          ...
          <section className={`border rounded-[3rem] p-8 md:p-10 space-y-10 transition-all duration-500 ${
            ...
            <div className="flex flex-col sm:flex-row items-center gap-8">
              <div className="relative group/avatar">
                ...
                <label className="absolute bottom-0 right-0 p-3 bg-orange-600 text-white rounded-full shadow-xl cursor-pointer hover:bg-orange-500 transition-colors">
                  <Camera size={16} />
              ...
              <div className="space-y-2 text-center sm:text-left">
                ...
                <div className="flex items-center justify-center sm:justify-start gap-2 px-4 py-1.5 bg-orange-600 text-white rounded-full w-fit mx-auto sm:mx-0 shadow-lg">
                  <Shield size={12} />
              ...
              <div className="space-y-3">
                ...
                <input 
                  ...
                  className={`w-full border rounded-2xl h-14 px-6 font-bold focus:outline-none transition-all shadow-sm ${
                    isDark 
                      ? 'bg-white/5 border-white/10 text-white focus:bg-white/10 focus:border-orange-500/50' 
                      : 'bg-slate-50 border-slate-200 text-slate-900 focus:bg-white focus:border-orange-300'
                  }`}
                />
              </div>
              <div className="space-y-3">
            ...
            <div className="space-y-3">
              ...
              <textarea 
                ...
                className={`w-full border rounded-[2rem] p-8 text-sm font-medium focus:outline-none min-h-[180px] transition-all shadow-sm ${
                  isDark 
                    ? 'bg-white/5 border-white/10 text-zinc-200 focus:bg-white/10 focus:border-orange-500/50' 
                    : 'bg-slate-50 border-slate-200 text-slate-700 focus:bg-white focus:border-orange-300'
                }`}
              />
            </div>
          </section>
            ...
            isDark ? 'bg-black/35 border-white/5 shadow-2xl' : 'bg-white border-slate-200/80 shadow-[0_8px_30px_rgb(0,0,0,0.03)]'
             ...
             <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
                ...
                <button 
                  ...
                  className="w-full sm:w-auto px-6 py-4 bg-orange-600 text-white rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-orange-500 transition-all shadow-xl shadow-orange-600/10"
                >
                   + Adicionar Serviço
                </button>
             </div>
                     ...
                     <div className="md:col-span-1">
                        <input 
                          ...
                          className={`w-full border h-12 rounded-xl px-4 text-[10px] font-black uppercase focus:outline-none transition-all ${
                            isDark 
                              ? 'bg-white/10 border-white/10 text-white focus:bg-white/15 focus:border-orange-500/50' 
                              : 'bg-white border-slate-200 text-slate-900 focus:border-orange-300'
                          }`}
                        />
                     </div>
                     ...
                     <div className="md:col-span-2 flex items-center gap-4">
                        <input 
                          ...
                          className={`flex-1 border h-12 rounded-xl px-4 text-[10px] font-medium focus:outline-none transition-all ${
                            isDark 
                              ? 'bg-white/10 border-white/10 text-zinc-200 focus:bg-white/15 focus:border-orange-500/50' 
                              : 'bg-white border-slate-200 text-slate-600 focus:border-orange-300'
                          }`}
                        />
                        <button 
                ...
                <div className="space-y-4 mt-6">
                  ...
                  >
                      <div className="flex items-center gap-4">
                         <div className={`p-3 rounded-xl shadow-lg transition-all ${
                           connectedPlatforms.includes('INSTAGRAM') 
                             ? 'bg-gradient-to-tr from-yellow-600 via-pink-600 to-orange-600 text-white ring-2 ring-emerald-500 ring-offset-2 dark:ring-offset-[#131110] ring-offset-white' 
                  ...
                  >
                      <div className="flex items-center gap-4">
                         <div className={`p-3 rounded-xl shadow-lg transition-all ${
                           connectedPlatforms.includes('TIKTOK') 
                             ? 'bg-black text-white ring-2 ring-emerald-500 ring-offset-2 dark:ring-offset-[#131110] ring-offset-white border border-white/10' 
                             : 'bg-slate-900 text-white'
                         }`}>
                  ...
                  >
                      <div className="flex items-center gap-4">
                         <div className={`p-3 rounded-xl shadow-lg transition-all ${
                           connectedPlatforms.includes('YOUTUBE') 
                             ? 'bg-[#FF0000] text-white ring-2 ring-emerald-500 ring-offset-2 dark:ring-offset-[#131110] ring-offset-white' 
                             : 'bg-slate-900 text-white'
                         }`}>
