...
export default function DemoPage() {
  ...
  return (
    <div className="min-h-screen bg-[#07040d] text-white flex flex-col font-sans selection:bg-purple-600/30">
      ...
      <header className="relative z-10 border-b border-[#2e2452]/50 bg-[#0d091a]/40 backdrop-blur-md px-8 py-5 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <span className="text-xs font-black uppercase tracking-[0.4em] text-purple-400">InfluNext Neural Engine</span>
        </div>
      ...
      <main className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-8 p-8 relative z-10">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className={`p-6 rounded-2xl border transition-all ${
              currentStep === 1 
                ? 'bg-[#181136]/50 border-purple-500 shadow-xl shadow-purple-500/5' 
                : 'bg-[#100b24]/30 border-[#2e2452]/40 opacity-60'
            }`}>
              <div className="flex items-start justify-between gap-4">
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    <span className={`w-6 h-6 rounded-full flex items-center justify-center text-[10px] font-black ${currentStep === 1 ? 'bg-purple-600' : 'bg-zinc-800'}`}>1</span>
                    ...
                    <div className="flex items-center gap-3 pt-3">
                      <div className="relative w-48">
                        ...
                        <input 
                          ...
                          className="w-full h-9 bg-[#110c26] border border-[#2e2452] rounded-xl pl-6 pr-3 text-xs font-bold text-white focus:outline-none focus:border-purple-500"
                        />
                      </div>
                      <button 
                        onClick={() => runStep(1)}
                        disabled={isExecuting}
                        className="h-9 px-4 bg-purple-600 hover:bg-purple-500 text-white rounded-xl text-[10px] font-black uppercase tracking-wider flex items-center gap-2 disabled:opacity-50"
                      >
            ...
            <div className={`p-6 rounded-2xl border transition-all ${
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    <span className={`w-6 h-6 rounded-full flex items-center justify-center text-[10px] font-black ${currentStep === 2 ? 'bg-purple-600' : 'bg-zinc-800'}`}>2</span>
                  ...
                  {currentStep === 2 && (
                    <button 
                      onClick={() => runStep(2)}
                      disabled={isExecuting}
                      className="h-9 px-4 bg-purple-600 hover:bg-purple-500 text-white rounded-xl text-[10px] font-black uppercase tracking-wider flex items-center gap-2 disabled:opacity-50 pt-2"
                    >
            ...
            <div className={`p-6 rounded-2xl border transition-all ${
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    <span className={`w-6 h-6 rounded-full flex items-center justify-center text-[10px] font-black ${currentStep === 3 ? 'bg-purple-600' : 'bg-zinc-800'}`}>3</span>
            ...
            <div className={`p-6 rounded-2xl border transition-all ${
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    <span className={`w-6 h-6 rounded-full flex items-center justify-center text-[10px] font-black ${currentStep === 4 ? 'bg-purple-600' : 'bg-zinc-800'}`}>4</span>
            ...
            <div className={`p-6 rounded-2xl border transition-all ${
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    <span className={`w-6 h-6 rounded-full flex items-center justify-center text-[10px] font-black ${currentStep === 5 ? 'bg-purple-600' : 'bg-zinc-800'}`}>5</span>
            ...
            <div className={`p-6 rounded-2xl border transition-all ${
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    <span className={`w-6 h-6 rounded-full flex items-center justify-center text-[10px] font-black ${currentStep === 6 ? 'bg-purple-600' : 'bg-zinc-800'}`}>6</span>
            ...
            {dbData.aiAnalysis && (
              <div className="bg-[#100b24]/60 border border-purple-500/20 rounded-[32px] p-6 space-y-6 mt-8 animate-in fade-in duration-500">
                <div className="flex items-center gap-3 border-b border-[#2e2452]/40 pb-4">
                  <Sparkles className="w-5 h-5 text-purple-400" />
                  <div>
                    <h3 className="text-xs font-black uppercase tracking-[0.2em] text-purple-400">Workspace do Influenciador (Simulado por IA)</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                    <h4 className="text-[10px] font-black text-purple-300 uppercase tracking-widest flex items-center gap-2">
                    ...
                    <div className="space-y-2.5">
                      {[
                        ...
                        <div key={idx} className="p-3 bg-[#181236]/30 border border-[#2e2452]/20 rounded-xl flex items-start gap-3">
                          <div className="text-[9px] font-black text-purple-400 uppercase w-14 pt-0.5">{item.day}</div>
                  ...
                  <div className="space-y-6">
                    ...
                    {/* influencer support */}
                    <div className="p-5 bg-[#181236]/30 border border-[#2e2452]/20 rounded-2xl space-y-3 border-l-4 border-l-purple-500">
                      <div className="flex items-center gap-2">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-[#100b24]/60 border border-[#2e2452]/50 rounded-[32px] p-6 space-y-6">
            <div>
              <h3 className="text-[10px] font-black uppercase tracking-[0.3em] text-purple-400 mb-1">Database Monitor</h3>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="p-4 bg-[#181236]/40 border border-[#2e2452]/30 rounded-2xl text-center space-y-1">
                ...
                <p className="text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-indigo-400">
                  {dbData.influScore || '---'}
                </p>
              </div>
              <div className="p-4 bg-[#181236]/40 border border-[#2e2452]/30 rounded-2xl text-center space-y-1">
            ...
            <div className="border-t border-[#2e2452]/30 pt-4 space-y-3">
              <div className="flex justify-between items-center text-xs">
                ...
                <span className={`px-2 py-0.5 rounded text-[9px] font-black uppercase tracking-wider ${
                  ...
                  dbData.activeContract?.escrowStatus === 'IN_PROGRESS' ? 'bg-purple-500/10 text-purple-400' :
          ...
          <div className="bg-[#100b24]/60 border border-[#2e2452]/50 rounded-[32px] p-6 flex flex-col h-[380px]">
            <div className="mb-4">
              <div className="flex items-center gap-2 mb-1">
                ...
                <h3 className="text-[10px] font-black uppercase tracking-[0.3em] text-purple-400">AI Mentor Chat</h3>
              </div>
            ...
            <form onSubmit={handleSendChatMessage} className="flex gap-2">
              <input 
                ...
                className="flex-1 h-10 px-4 bg-[#110c26] border border-[#2e2452] rounded-xl text-xs text-white focus:outline-none focus:border-purple-500 disabled:opacity-40"
              />
              <button 
                type="submit"
                disabled={!dbData.aiAnalysis || isChatLoading}
                className="w-10 h-10 bg-purple-600 hover:bg-purple-500 text-white rounded-xl flex items-center justify-center transition-colors disabled:opacity-40"
              >
