...
const recebidos_routes_1 = __importDefault(require("./recebidos.routes"));
const marketing_intelligence_routes_1 = __importDefault(require("./marketing-intelligence.routes"));
...
routes.use('/recebidos', recebidos_routes_1.default);
routes.use('/marketing-intelligence', marketing_intelligence_routes_1.default);
